            ...
            <div class="inbox_chat">
              ...
              <div class="chat_list active_chat">
                ...
                <div class="chat_people">
                  ...
                  ?>
                    <h5>{{TradeHelp::get_post_member($data->initiated_by)}}({{TradeHelp::get_post($data->post_id)}})<span class="chat_date">{{date("M", mktime(0, 0, 0, $month, 10))}} {{$day}}</span></h5>
...
$(document).ready(function() {
    ...
    $("body").delegate("#msg_send", "click", function(){
      ...
      $.ajax({
        type: 'post',
        url: 'http://localhost:8000/saveusermessage',
        dataType: 'json',
        //cache:false,
        data: data,
