<div id="header" class="container-fluid fixed-top" style="background:white;">
  ...
  <form class="form-inline col-6   searching-inn">
    ...
    <button class="form-control search-inn-color" type="submit">Search</button>
      ...
      <div class="div-over-right"> <a href="login.html" data-toggle="modal" data-target="#exampleModalLogin">Login</a> <a href="registration.html"  data-toggle="modal" data-target="#exampleModalRegister">Register</a> </div>
